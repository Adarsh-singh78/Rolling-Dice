...
console.log(44+'55');
const x=(min,max)=>{return Math.trunc(Math.random()*(max-min+1))+min}
console.log(x(10,20));
...
// const stri='adarsh';
// console.log(stri.padStart(4+stri.length,'itz_'));

const d1=new Date(2001,7,22,2,15);
const d2=new Date(0);
console.log(d1-d2);


// (function(d1,d2){
//   console.log(Math.abs(d1-d2)/(1000*60*60*24));
// })
// (new Date(),new Date(2001,7,22));